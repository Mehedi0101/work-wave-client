...
const Footer = () => {
    return (
        <footer className=" md:p-10 px-5 py-10 text-neutral-content mt-20 bg-[#2b487c]">
            <div className="footer mx-auto max-w-[1516px]">
                <aside className="text-sm">
                    <Link to='/'><img className="w-40" src={logo} alt="" /></Link>
                    <p>Simplify Your Day, Achieve More Your Way!</p>
                    <p className="mt-2">Empowering productivity since 2023</p>
                </aside>
                <nav>
            ...
            <p className="mt-8 text-[#ffffff86] md:text-center text-left text-xs">Copyright © 2023 - All right reserved by WORKWAVE<sup className="text-[10px]">TM</sup></p>
        </footer>
    );
};
